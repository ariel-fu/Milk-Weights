...
public class DateRangeReport extends ReportBase {
	...
	public DateRangeReport(HashMap<String, Farm> farms, LocalDate day1, LocalDate day2) {
		this.farms = farms;
		this.day1 = day1;
		this.day2 = day2;
		totalPerFarm = new ArrayList<>();

		// Prasun: initialize first because when doing set will get index 0 out of bound
		// of length 0
